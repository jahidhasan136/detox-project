...
const ApplicationFocus = () => {
    return (
        ...
        <div className="mt-[120px] md:hidden">
                <div className="mb-[30px] container mx-auto">
                    <h1 className="text-2xl text-center font-bold">Application Focus</h1>
                </div>
            <Swiper
                slidesPerView={1}
                spaceBetween={30}
                ...
                <SwiperSlide>
                    <div className="w-[342px] border border-[#eeeeee33] p-[32px] rounded-[15px] card_back mx-auto">
                        <img className="mb-[23px]" src={b2b} alt="" />
                        <h2 className="mb-[16px] text-2xl font-semibold">B2B, B2C, C2C, P2P</h2>
                        <p className="mb-[24px] text-base font-medium">The platform is designed to allow users to transact between phone and email systems. using Legacy</p>
                        <button className="text-sm border border-[#F95B27] px-6 py-3 rounded-xl hover:bg-[#F95B27]">Read More</button>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="w-[342px] border border-[#eeeeee33] card_back p-[32px] rounded-[15px] mx-auto">
                        <img className="mb-[23px]" src={digital} alt="" />
                        <h2 className="mb-[26px] text-2xl font-semibold">Digital First Focus</h2>
                        <p className="mb-9 text-base font-medium">The platform is designed to allow users to transact between phone and email systems. using Legacy</p>
                        <button className="text-sm border border-[#F95B27] px-6 py-3 rounded-xl hover:bg-[#F95B27]">Read More</button>
